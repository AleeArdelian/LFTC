class RegularGrammar:
    ...
    def readFromKeyboard(self):
        print("Please insert non-terminals: \n Insert 0 to stop \n")
        non_terminal = input("Non-terminal: ")
        while non_terminal != 0:
            self._nonTerminals.append(non_terminal)
            non_terminal = input("Non-terminal: ")

        print("Please insert terminals: \n Insert 0 to stop \n")
        ...
        productions = []
        print("Please insert production of type X->.... : \n Insert 0 to stop \n")
        production = input("Production: ")
        while production != 0:
            productions.append(production)
            production = input("Production: ")
        startingSymbol = input("Please insert starting symbol: ")
        self._nonTerminals.append(startingSymbol)
